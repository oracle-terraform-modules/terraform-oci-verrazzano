...
# resource "oci_objectstorage_bucket" "thanos_johannesburg" {
#   compartment_id = var.compartment_id
#   name           = "mel-${lookup(var.thanos, "bucket_name", "thanos")}"
#   namespace      = lookup(var.thanos, "bucket_namespace")

#   provider = oci.johannesburg

#   count = tobool(lookup(var.clusters, "johannesburg", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }

# module "johannesburg_drg" {
...
#   # drg parameters
#   drg_display_name = "johannesburg-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.johannesburg[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "johannesburg", "false")) ? 1 : 0
#   providers = {
#     oci = oci.johannesburg
#   }
# }