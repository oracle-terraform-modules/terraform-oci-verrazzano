...
#   count = tobool(lookup(var.clusters, "abudhabi")) ? 1 : 0

# }

# resource "oci_objectstorage_bucket" "thanos_abudhabi" {
#   compartment_id = var.compartment_id
#   name           = "mel-${lookup(var.thanos, "bucket_name", "thanos")}"
#   namespace      = lookup(var.thanos, "bucket_namespace")

#   provider = oci.abudhabi

#   count = tobool(lookup(var.clusters, "abudhabi", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "abudhabi-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.abudhabi[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "abudhabi", "false")) ? 1 : 0
#   providers = {
#     oci = oci.abudhabi
#   }
# }