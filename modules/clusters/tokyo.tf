...
#   count = tobool(lookup(var.clusters, "tokyo")) ? 1 : 0

# }

# resource "oci_objectstorage_bucket" "thanos_tokyo" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "tokyo", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "tokyo-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.tokyo[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "tokyo", "false")) ? 1 : 0
#   providers = {
#     oci = oci.tokyo
#   }
# }