...
# resource "oci_objectstorage_bucket" "thanos_montreal" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "montreal", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "montreal-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.montreal[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "montreal", "false")) ? 1 : 0
#   providers = {
#     oci = oci.montreal
#   }
# }