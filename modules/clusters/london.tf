...
#   count = tobool(lookup(var.clusters, "london")) ? 1 : 0
...
#   count = tobool(lookup(var.clusters, "london", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "london-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.london[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "london", "false")) ? 1 : 0
#   providers = {
#     oci = oci.london
#   }
# }