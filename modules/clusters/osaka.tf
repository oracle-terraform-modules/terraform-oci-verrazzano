...
#   count = tobool(lookup(var.clusters, "osaka")) ? 1 : 0

# }

# resource "oci_objectstorage_bucket" "thanos_osaka" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "osaka", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "osaka-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.osaka[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "osaka", "false")) ? 1 : 0
#   providers = {
#     oci = oci.osaka
#   }
# }