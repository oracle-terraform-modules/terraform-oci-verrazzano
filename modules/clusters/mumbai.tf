...
# resource "oci_objectstorage_bucket" "thanos_mumbai" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "mumbai", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "mumbai-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.mumbai[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "mumbai", "false")) ? 1 : 0
#   providers = {
#     oci = oci.mumbai
#   }
# }