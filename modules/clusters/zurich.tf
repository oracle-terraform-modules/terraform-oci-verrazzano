...
# resource "oci_objectstorage_bucket" "thanos_zurich" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "zurich", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "zurich-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.zurich[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "zurich", "false")) ? 1 : 0
#   providers = {
#     oci = oci.zurich
#   }
# }