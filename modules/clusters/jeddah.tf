...
#   count = tobool(lookup(var.clusters, "jeddah")) ? 1 : 0

# }

# resource "oci_objectstorage_bucket" "thanos_jeddah" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "jeddah", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "jeddah-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.jeddah[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "jeddah", "false")) ? 1 : 0
#   providers = {
#     oci = oci.jeddah
#   }
# }