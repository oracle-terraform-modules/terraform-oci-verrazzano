...
# resource "oci_objectstorage_bucket" "thanos_queretaro" {
#   compartment_id = var.compartment_id
#   name           = "mel-${lookup(var.thanos, "bucket_name", "thanos")}"
#   namespace      = lookup(var.thanos, "bucket_namespace")

#   provider = oci.queretaro

#   count = tobool(lookup(var.clusters, "queretaro", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }

# module "queretaro_drg" {
...
#   # drg parameters
#   drg_display_name = "queretaro-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.queretaro[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "queretaro", "false")) ? 1 : 0
#   providers = {
#     oci = oci.queretaro
#   }
# }