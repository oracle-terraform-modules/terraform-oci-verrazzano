...
# resource "oci_objectstorage_bucket" "thanos_vinhedo" {
#   compartment_id = var.compartment_id
#   name           = "mel-${lookup(var.thanos, "bucket_name", "thanos")}"
#   namespace      = lookup(var.thanos, "bucket_namespace")

#   provider = oci.vinhedo

#   count = tobool(lookup(var.clusters, "vinhedo", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "vinhedo-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.vinhedo[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "vinhedo", "false")) ? 1 : 0
#   providers = {
#     oci = oci.vinhedo
#   }
# }