...
#   count = tobool(lookup(var.clusters, "chicago")) ? 1 : 0

# }

# resource "oci_objectstorage_bucket" "thanos_chicago" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "chicago", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "chicago-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.chicago[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "chicago", "false")) ? 1 : 0
#   providers = {
#     oci = oci.chicago
#   }
# }