...
# resource "oci_objectstorage_bucket" "thanos_amsterdam" {
#   compartment_id = var.compartment_id
#   name           = "mel-${lookup(var.thanos, "bucket_name", "thanos")}"
#   namespace      = lookup(var.thanos, "bucket_namespace")

#   provider = oci.amsterdam

#   count = tobool(lookup(var.clusters, "amsterdam", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }

# module "amsterdam_drg" {
...
#   # drg parameters
#   drg_display_name = "amsterdam-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.amsterdam[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "amsterdam", "false")) ? 1 : 0
#   providers = {
#     oci = oci.amsterdam
#   }
# }