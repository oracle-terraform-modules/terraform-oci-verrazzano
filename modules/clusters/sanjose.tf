...
# resource "oci_objectstorage_bucket" "thanos_sanjose" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "sanjose", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "sanjose-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.sanjose[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "sanjose", "false")) ? 1 : 0
#   providers = {
#     oci = oci.sanjose
#   }
# }