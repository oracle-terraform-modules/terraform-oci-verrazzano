...
# resource "oci_objectstorage_bucket" "thanos_phoenix" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "phoenix", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "phoenix-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.phoenix[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "phoenix", "false")) ? 1 : 0
#   providers = {
#     oci = oci.phoenix
#   }
# }