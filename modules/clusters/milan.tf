...
# resource "oci_objectstorage_bucket" "thanos_milan" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "milan", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "milan-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.milan[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "milan", "false")) ? 1 : 0
#   providers = {
#     oci = oci.milan
#   }
# }