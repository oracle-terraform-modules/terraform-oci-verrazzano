...
#   count = tobool(lookup(var.clusters, "paris")) ? 1 : 0

# }

# resource "oci_objectstorage_bucket" "thanos_paris" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "paris", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "paris-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.paris[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "paris", "false")) ? 1 : 0
#   providers = {
#     oci = oci.paris
#   }
# }