...
# resource "oci_objectstorage_bucket" "thanos_frankfurt" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "frankfurt", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }

# module "frankfurt_drg" {
...
#   # drg parameters
#   drg_display_name = "frankfurt-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.frankfurt[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "frankfurt", "false")) ? 1 : 0
#   providers = {
#     oci = oci.frankfurt
#   }
# }