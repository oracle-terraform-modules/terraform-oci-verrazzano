...
#   count = tobool(lookup(var.clusters, "newport")) ? 1 : 0

# }

# resource "oci_objectstorage_bucket" "thanos_newport" {
#   compartment_id = var.compartment_id
#   name           = "${var.label_prefix}-${lookup(var.thanos, "bucket_name", "thanos")}"
#   namespace      = lookup(var.thanos, "bucket_namespace")

#   provider = oci.newport

#   count = tobool(lookup(var.clusters, "newport", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "newport-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.newport[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "newport", "false")) ? 1 : 0
#   providers = {
#     oci = oci.newport
#   }
# }