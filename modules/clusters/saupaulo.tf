...
# resource "oci_objectstorage_bucket" "thanos_saupaulo" {
#   compartment_id = var.compartment_id
#   name           = "mel-${lookup(var.thanos, "bucket_name", "thanos")}"
#   namespace      = lookup(var.thanos, "bucket_namespace")

#   provider = oci.saupaulo

#   count = tobool(lookup(var.clusters, "saupaulo", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "saupaulo-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.saupaulo[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "saupaulo", "false")) ? 1 : 0
#   providers = {
#     oci = oci.saupaulo
#   }
# }