...
# resource "oci_objectstorage_bucket" "thanos_madrid" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "madrid", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "madrid-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.madrid[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "madrid", "false")) ? 1 : 0
#   providers = {
#     oci = oci.madrid
#   }
# }