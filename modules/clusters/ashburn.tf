...
# resource "oci_objectstorage_bucket" "thanos_ashburn" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "ashburn", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }
...
#   # drg parameters
#   drg_display_name = "ashburn-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.ashburn[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "ashburn", "false")) ? 1 : 0
#   providers = {
#     oci = oci.ashburn
#   }
# }