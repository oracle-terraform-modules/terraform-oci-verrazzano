...
#   count = tobool(lookup(var.clusters, "marseille")) ? 1 : 0

# }

# resource "oci_objectstorage_bucket" "thanos_marseille" {
#   compartment_id = var.compartment_id
...
#   count = tobool(lookup(var.clusters, "marseille", "false")) && tobool(lookup(var.thanos, "enabled", "false")) ? 1 : 0
# }

# module "marseille_drg" {
...
#   # drg parameters
#   drg_display_name = "marseille-drg"

#   drg_vcn_attachments = {
#     drg = {
#       vcn_id                    = module.marseille[0].vcn_id
...
#   count = tobool(lookup(var.clusters, "marseille", "false")) ? 1 : 0
#   providers = {
#     oci = oci.marseille
#   }
# }